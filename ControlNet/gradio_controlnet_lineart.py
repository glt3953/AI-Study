...
client = Client("https://8342-34-83-211-102.ngrok-free.app/")
result = client.predict(
                "Lineart",    # str  in 'Preprocessor' Radio component
                "11684737257_.pic_hd.jpg", #IMG_8298.JPG, 证件照.jpg
                "Ghibli style of handsome young man",    # str  in 'Prompt' Textbox component
