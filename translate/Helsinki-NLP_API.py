...
model = "Helsinki-NLP/opus-mt-zh-en" #Helsinki-NLP/opus-mt-en-zh、Helsinki-NLP/opus-mt-zh-en
...
# 翻译文本
content = "苹果是一家美国跨国科技公司。"
#content = "Apple is an American multinational technology company."
result = query({"inputs" : content, "wait_for_model" : True})
print(result)
